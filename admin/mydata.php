...
<div class="row">
        ...
        <div class="panel panel-green">
            <div class="panel-heading">
                <div class="row">
                    ...
                    $query = "SELECT * FROM posts INNER JOIN comments ON posts.post_id = comments.comment_post_id WHERE post_user = '".$_SESSION['username']."' ";
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-red">
          ...
          $query= "SELECT * FROM posts WHERE post_status = 'Published' AND post_user = '".$_SESSION['username']."' ";
          ...
          $query= "SELECT * FROM posts INNER JOIN comments ON posts.post_id = comments.comment_post_id WHERE post_user = '".$_SESSION['username']."' AND comment_status = 'unapproved'";
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Data', 'Count'],
           ...
           $element_count = [$post_counts, $post_published_counts ,$post_draft_counts,  $count_comments, $unapproved_comments_count, $count_users, $subscriber_counts, $count_categories];
